...
<html>
<head>
<title>adsense.accounts.list | GoogleAdSense</title>
...
<body>
    <div class="container">
        ...
        ?>
        <hr />
        <h4>Request: <span class="badge badge-success">adsense.accounts.list</span></h4>
        <strong>- List all accounts available to this AdSense account.</strong> <br /><br />       
        <?php
                ...
                do {
                  ...
                  if (isset($accounts)) {
                    foreach ($accounts as $account) {
                      $format = 'Account with ID "%s" and name "%s".';
