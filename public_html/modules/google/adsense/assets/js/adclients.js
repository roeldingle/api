...
<html>
<head>
<title>adsense.adclients.list | GoogleAdSense</title>
...
<body>
    <div class="container">
        ...
        ?>
        <hr />
        <h4>Request: <span class="badge badge-success">adsense.adclients.list</span></h4>
        <strong>- List all ad clients in the specified account.</strong> <br /><br />       
        <?php
        ...
        try {
            ...
            if (isset($result['items'])) {
                ...
                <tr>
                    ...
                    <td><?php echo $rows['supportsReporting'];?></td>
                </tr>
                <?php
                }
            }
